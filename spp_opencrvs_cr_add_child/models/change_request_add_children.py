...
class ChangeRequestAddChildMember(models.Model):
    _name = "spp.opencrvs.cr.add.child"
    _inherit = [
    ...
    DMS_STORAGE = "spp_opencrvs_cr_add_child.attachment_storage_add_child"
    VALIDATION_FORM = (
        "spp_opencrvs_cr_add_child.view_change_request_add_child_validation_form"
    )
    ...
    validation_ids = fields.Many2many(
        relation="spp_opencrvs_cr_add_child_rel",
